...
final List<Doa> doaList = [
  ...
  Doa(
    ...
    latin:
        'Allâhumma innî as\'aluka khairal maulaji wa khairal makhraji',
    arti: 'Ya Allah, aku memohon kepada-Mu sebaik-baik tempat masuk dan keluar.',
    keywords: ['masuk rumah', 'rumah'],
  ),
  Doa(
